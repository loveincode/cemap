...
@Controller
@RequestMapping(value = "/collegeadminmember")
public class CollegeAdminMemberController {
    ...
    public ModelAndView indexPage(HttpServletRequest request,
        ...
        modelAndView.setViewName("member/collegeadmin/index");
        return modelAndView;
    }
    ...
    public String data(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            // 总记录数
            Integer recordsTotal = memberService.listMemberByinfo(null,null,5,-1,-1).size();
            // 关键字过滤后总记录数
            Integer recordsFiltered = memberService.listMemberByinfo(username,realname,5,-1, -1).size();
            dataTableUtil.setResult(recordsTotal, recordsFiltered,
                    memberService.listMemberByinfo(username,realname,5,dataTableUtil.getPage(),
    ...
    public ModelAndView addPage(HttpServletRequest request,
            HttpServletResponse response) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("member/collegeadmin/add");
        return modelAndView;
    }
    ...
    public @ResponseBody String add(
        ...
        try {
            ...
            Role role = new Role();
            role = userDao.findRoleByRoleCode(CEMAPConstants.CEMAP_ROLE_CODE_COLLEGE_ADMIN);
            roles.add(role);
            member.setRoles(roles);
            member.setTempRoleId(5);
    ...
    public ModelAndView modifyPage(
        ...
        try {
            ...
            modelAndView.setViewName("member/collegeadmin/modify");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return modelAndView;
    ...
    public ModelAndView passwordModifyPage(
        ...
        ModelAndView modelAndView = new ModelAndView();
            try {
                Member member = memberService.getByUuid(uuid);
                modelAndView.addObject("member", member);
                modelAndView.setViewName("member/collegeadmin/passwordmodify");
