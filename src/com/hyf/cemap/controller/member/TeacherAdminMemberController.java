...
@Controller
@RequestMapping(value = "/teacheradminmember")
public class TeacherAdminMemberController {
    ...
    public ModelAndView indexPage(HttpServletRequest request,
        ...
        modelAndView.setViewName("member/teacheradmin/index");
        return modelAndView;
    }
    ...
    public String data(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            // 总记录数
            Integer recordsTotal = memberService.listMemberByinfo(null,null,2,-1,-1).size();
            // 关键字过滤后总记录数
            Integer recordsFiltered = memberService.listMemberByinfo(username,realname,2,-1, -1).size();
            dataTableUtil.setResult(recordsTotal, recordsFiltered,
                    memberService.listMemberByinfo(username,realname,2,dataTableUtil.getPage(),
    ...
    public ModelAndView addPage(HttpServletRequest request,
            HttpServletResponse response) {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("member/teacheradmin/add");
        return modelAndView;
    }
    ...
    public @ResponseBody String add(
        ...
        try {
            ...
            Role role = new Role();
            role = userDao.findRoleByRoleCode(CEMAPConstants.CEMAP_ROLE_CODE_TEACHER_ADMIN);
            roles.add(role);
            member.setRoles(roles);
            member.setTempRoleId(2);
    ...
    public ModelAndView modifyPage(
        ...
        try {
            ...
            modelAndView.setViewName("member/teacheradmin/modify");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return modelAndView;
    ...
    public ModelAndView passwordModifyPage(
        ...
        ModelAndView modelAndView = new ModelAndView();
            try {
                Member member = memberService.getByUuid(uuid);
                modelAndView.addObject("member", member);
                modelAndView.setViewName("member/teacheradmin/passwordmodify");
