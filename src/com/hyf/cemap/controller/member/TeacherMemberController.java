...
@Controller
@RequestMapping(value = "/teachermember")
public class TeacherMemberController {
    ...
    public ModelAndView indexPage(HttpServletRequest request,
        ...
        modelAndView.setViewName("member/teacher/index");
        return modelAndView;
    }
    ...
    public @ResponseBody String add(
        ...
        try {
            ...
            Role role = new Role();
            role = userDao.findRoleByRoleCode(CEMAPConstants.CEMAP_ROLE_CODE_TEACHER);
            roles.add(role);
            member.setRoles(roles);
            member.setTempRoleId(3);
    ...
    public ModelAndView modifyPage(
        ...
        try {
            ...
            List<AdministrativeClass> administrativeClasss = administrativeClassService.listAll(-1, -1);
            modelAndView.addObject("administrativeClasss", administrativeClasss);
            modelAndView.setViewName("member/teacher/modify");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return modelAndView;
    ...
    public @ResponseBody String update(
        ...
        try {
            ...
            omember.setManageClass(member.getManageClass());
    ...
    public ModelAndView passwordModifyPage(
        ...
        ModelAndView modelAndView = new ModelAndView();
            try {
                Member member = memberService.getByUuid(uuid);
                modelAndView.addObject("member", member);
                modelAndView.setViewName("member/teacher/passwordmodify");
