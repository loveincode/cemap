 ...
 * 毕业档案Controller
*  @author  huyifan
*  @ClassName  GraduationFileController  
*  @date  2017年3月8日 下午4:58:49
 */
@Controller
@RequestMapping(value = "/graduationfile")
public class GraduationFileController {
...
//		modelAndView.setViewName("newstype/index");
	...
	public ModelAndView addPage(HttpServletRequest request,
			HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("graduationfile/add");
		return modelAndView;
	}
