...
jQuery.validator.addMethod("isPhone", function(value, element) {    
    ...
    var phone = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(147))+\d{8})$/;
...
jQuery.validator.addMethod("isOrganizationCode", function(value, element) {
    var length = value.length;
    var organizationCode = /^[0-9]{8}[A-Za-z]{1}$/;
    return this.optional(element) || (length == 9 && organizationCode.test(value));
    },"请输入正确的组织结构码（9位），最后一位为字母");
