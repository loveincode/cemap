...
<body class="gray-bg">
    ...
    $('#addBtn').click(function () {
        window.location.href = "${ctxStatic}/preachingmeeting/addPage";
    });
	...
	$(document).ready(function(){
		...
		var table = $('#data-Table').dataTable( {
			...
			"serverSide": true,
	        "ajax": {
	        	url:"${ctxStatic}/preachingmeeting/data",
	    		headers: {
	        ...
	        "columnDefs": [
	            ...
	            "render": function(data, type, row) {
	                return "<a href='${ctxStatic}/preachingmeeting/modifyPage?uuid=" + data + "'><i class=\"fa fa-edit text-navy\"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a value='" + data + "' onclick=deletefunc(" + "\'" + data + "\'" +")><i class=\"fa fa-times text-navy\"></i></a>";
	            },
	            "targets": 6}
	        ]
	    } );
