...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
    	...
    	<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
						<label class="col-sm-3 control-label" style="padding-left:5px;padding-top:6px;">姓名：</label>
						<div class="col-sm-9">
			...
			<div class="col-md-3">
				<div class="form-group">
						<label class="col-sm-3 control-label" style="padding-left:5px;padding-top:6px;">学号：</label>
						<div class="col-sm-9">
						<input id="sstudentId" name="sstudentId" class="form-control"
								type="text" aria-required="true" aria-invalid="true"
								class="error" value="" placeholder="精确">
					</div>
				</div>
			</div>
	...
	$(document).ready(function(){
		var table = $('#data-Table').dataTable( {
			...
			"serverSide": true,
	        "ajax": {
	        	url:"${ctxStatic}/graduateinformation/data",
	    		headers: {
			    ...
			    data: function(request){ 
				    	...
				    	{
				    		request.sname = sname1;
				    	}
				    	if(sstudentId1 !=null && sstudentId1!="")
				    	{
				    		request.sstudentId = sstudentId1;
				    	}
			    	return request;
			        }
	        },
	        ...
	        "columnDefs": [
	            ...
	            "render": function(data, type, row) {
	                return "<a href='${ctxStatic}/graduateinformation/modifyPage?uuid=" + data + "'><i class=\"fa fa-edit text-navy\"></i>修改</a>"
	                		+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	                		+"<a href='${ctxStatic}/graduateinformation/modifyFilePage?uuid=" + data + "'>档案</a>"
	                		+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	                		+"<a href='${ctxStatic}/graduateinformation/modifyEmployPage?uuid=" + data + "'>就业信息</a>"
	                		+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	                		+"<security:authorize ifAnyGranted='ROLE_ADMIN,ROLE_TEACHER_ADMIN'>"
	                		+"<a value='" + data + "' onclick=deletefunc(" + "\'" + data + "\'" +")><i class=\"fa fa-times text-navy\"></i>删除</a>"
	                		+"</security:authorize>";
	            },
	            "targets": 6}
	        ]
