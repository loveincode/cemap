...
<body class="gray-bg">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    ...
	                    <form class="form-horizontal m-t" id="modifyform">
	                    	...
	                    	<input type="hidden" id="studentId1" value="${studentId1}"/>
							...
							<div class="col-md-7 col-sm-offset-5">
								...
								<button  class="btn btn-primary" type="button" onclick="deleteemploy('${employmentInformation.uuid}')">
	...
	<script type="text/javascript">
		...
		function deleteemploy(data){
		    var result = confirm("确定要删除吗？");
	       	if(result){
	           $.ajax
	           ({ 
	               url: "deleteemploy?uuid="+data,
	               method: 'GET',
	               dataType: "json", 
	               data: { 
	               },
