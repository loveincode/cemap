	                    ...
	                    <form class="form-horizontal m-t" id="modifyform">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="graduationSession" name="graduationSession" class="form-control required digits"
											placeholder="请输入毕业届数" value="${graduateInformation.graduationSession}">
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="studentId" name="studentId" class="form-control required digits"
											placeholder="请输入学号" value="${graduateInformation.studentId}" />
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="name" name="name" class="form-control required"
											placeholder="请输入姓名" value="${graduateInformation.name}" >
									</div>
								</div>
							</div>
							</div>
								...
								<div class="form-group" id="data_1">
									...
									<div class="col-sm-7">
										...
										<span class="input-group-addon"><i
												...
												class="form-control required dateISO" value="${graduateInformation.birthday}" readonly="readonly">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="nativePlace" name="nativePlace" class="form-control required"
											placeholder="籍贯 省 市"  value="${graduateInformation.nativePlace}" >
									</div>
								</div>
							</div>
							</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text"  id="identificationNumber" name="identificationNumber" class="form-control required isIdCardNo"
											placeholder="请输入身份证号码"  value="${graduateInformation.identificationNumber}" >
									</div>
								</div>
							</div>
							</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<select class="form-control required" id="originPlace" name="originPlace" value="${graduateInformation.originPlace}">
												<option>上海</option>
												<option>北京</option>
												<option>天津</option>
												<option>重庆</option>
			...
			$("#modifyform").validate({
				...
				submitHandler: function (form) {
					...
					success : function(data) {
						alert(data.message);
	               		console.log(data);
						window.location.href = "${ctxStatic}/graduateinformation/index";
					},
					error : function(data) {
						alert("error");
					}
