...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
    	...
    	<div class="row">
    		...
    		<div class="col-md-3">
				<div class="form-group">
						<label class="col-md-3 control-label" style="padding-left:5px;padding-top:6px;">学院：</label>
						<div class="col-md-9">
			...
			<div class="col-md-3">
				<div class="form-group">
						<label class="col-md-3 control-label" style="padding-left:5px;padding-top:6px;">专业：</label>
						<div class="col-md-9">
			...
			<div class="col-md-3">
				<div class="form-group">
						<label class="col-md-3 control-label" style="padding-left:5px;padding-top:6px;">班级：</label>
						<div class="col-md-9">
       ...
       <div class="row">
       		<!-- 学历人数 -->
       		<div style="display:none" class="col-md-5 col-md-offset-1 chart" id="people-chart"></div>
       		<!-- 男女人数 -->
       		<div class="col-md-10 col-md-offset-1 chart" id="sex-chart"></div>
       </div>
       <br/>
	   <br/>
       <div class="row">
    ...
    $("#query-btn").on("click",function(){
		...
		sprofessionId = $("#sprofessionId").val();
		sadministrativeClassId = $("#sadministrativeClassId").val();
    	Bionload(scollegeId,sprofessionId,sadministrativeClassId);
    });
    
    console.log("当前年份："+getYear());
    //Bionload(getYear());
    function Bionload(collegeId,professionId,administrativeClassId){
    	$.ajax
	    ({ 
	        ...
	        success: function (data) {
	        		//alert(data.message);
	        		pie(2017,data.data.all,data.data.zhuan,data.data.ben,data.data.yan);
	    ...
	    ({ 
	        ...
	        success: function (data) {
	        		//alert(data.message);
	        		employpie(2017,data.data.hasemploy,data.data.noemploy);
	            	// window.location.reload();
	        }
	    })
