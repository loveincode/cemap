...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
    	...
    	<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
						<label class="col-md-3 control-label" style="padding-left:5px;padding-top:6px;">届数：</label>
						<div class="col-md-9">
    ...
    function getprofession(collegeId){
		...
		({ 
		    ...
		    success: function (data) {
	    		...
	    		$('#sprofessionId').append("<option value='-1'>请选择</option>");
	    		if(array.length>0){
		     		for(var o in array){
    ...
    $("#query-btn").on("click",function(){
    	...
    	Bionload(sgraduationSession,scollegeId,sprofessionId);
    });
    
    console.log("当前年份："+getYear());
    //Bionload(getYear());
    function Bionload(session,collegeId,professionId){
    	if(session!=-1){
    		console.log(session);
	    	$.ajax
		    ({ 
