                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
	                    ...
	                    <form class="form-horizontal m-t" id="modifyform">
	                    	...
	                    	<div style="display:none" id="destext">${recruitmentinformation.description}</div>
	                    	<input type="hidden" id="recruitmentinformationid" value="${recruitmentinformation.id}"/>
	                    	...
	                    	<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="companyName" name="companyName" class="form-control required"
												placeholder="请输入单位名称" value="${recruitmentinformation.companyName}">
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-7">
											<select class="form-control required" id="companyType" name="companyType" value="${recruitmentinformation.companyType}">
													<option>国有企业</option>
													<option>民营企业</option>
													<option>党政机关</option>
										...
										<input type="hidden" id="companyType2" value="${recruitmentinformation.companyType}">
									</div>
								</div>
							</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" id="theme" name="theme" class="form-control required"
												placeholder="请输入主题" value="${recruitmentinformation.theme}">
										</div>
									</div>
								</div>
										...
										<div class="col-sm-7">
												<div class="input-group date">
													<span class="input-group-addon"><i
														...
														class="form-control required dateISO" value="${recruitmentinformation.deadline}" readonly="readonly">
												</div>
											</div>
									</div>
								</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" id="email" name="email" class="form-control required email"
												placeholder="请输入邮箱" value="${recruitmentinformation.email}">
										</div>
									</div>
								</div>
							</div>
		...
		$("#modifyform").validate({
			...
			submitHandler: function (form) {
				...
				$.ajax({
					...
					url : "update",
					data : {
						id : $("#recruitmentinformationid").val(),
