...
<body class="gray-bg">
    ...
    $('#addBtn').click(function () {
        window.location.href = "${ctxStatic}/collegeadminmember/addPage";
    });
	...
	$(document).ready(function(){
		...
		var table = $('#data-Table').dataTable( {
			...
			"serverSide": true,
	        "ajax": {
	        	url:"${ctxStatic}/collegeadminmember/data",
	    		headers: {
	        ...
	        "columnDefs": [
	            ...
	            "render": function(data, type, row) {
	                return "<a href='${ctxStatic}/collegeadminmember/modifyPage?uuid=" + data + "'><i class=\"fa fa-edit text-navy\"></i></a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	               			+"<a href='${ctxStatic}/collegeadminmember/passwordModifyPage?uuid=" + data + "'>重置密码</a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	function deletefunc(data){
	    var result = confirm("确定要删除吗？");
           ...
           $.ajax
           ({ 
               url: "${ctxStatic}/collegeadminmember/delete?uuid="+data,
               method: 'GET',
               dataType: "json", 
               data: { 
               },
