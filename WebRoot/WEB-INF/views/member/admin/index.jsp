...
<body class="gray-bg">
    ...
    $('#addBtn').click(function () {
        window.location.href = "${ctxStatic}/adminmember/addPage";
    });
	...
	$(document).ready(function(){
		...
		var table = $('#data-Table').dataTable( {
			...
			"serverSide": true,
	        "ajax": {
	        	url:"${ctxStatic}/adminmember/data",
	    		headers: {
	        ...
	        "columnDefs": [
	            ...
	            "render": function(data, type, row) {
	                return "<a href='${ctxStatic}/adminmember/modifyPage?uuid=" + data + "'><i class=\"fa fa-edit text-navy\"></i></a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	               			+"<a href='${ctxStatic}/adminmember/passwordModifyPage?uuid=" + data + "'>重置密码</a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	function deletefunc(data){
	    var result = confirm("确定要删除吗？");
           ...
           $.ajax
           ({ 
               url: "${ctxStatic}/adminmember/delete?uuid="+data,
               method: 'GET',
               dataType: "json", 
               data: { 
               },
