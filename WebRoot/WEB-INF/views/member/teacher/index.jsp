...
<body class="gray-bg">
    ...
    $('#addBtn').click(function () {
        window.location.href = "${ctxStatic}/teachermember/addPage";
    });
	...
	$(document).ready(function(){
		...
		var table = $('#data-Table').dataTable( {
			...
			"serverSide": true,
	        "ajax": {
	        	url:"${ctxStatic}/teachermember/data",
	    		headers: {
	        ...
	        "columnDefs": [
	            ...
	            "render": function(data, type, row) {
	                return "<a href='${ctxStatic}/teachermember/modifyPage?uuid=" + data + "'><i class=\"fa fa-edit text-navy\"></i></a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	               			+"<a href='${ctxStatic}/teachermember/passwordModifyPage?uuid=" + data + "'>重置密码</a>"
	               			+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	function deletefunc(data){
	    var result = confirm("确定要删除吗？");
           ...
           $.ajax
           ({ 
               url: "${ctxStatic}/teachermember/delete?uuid="+data,
               method: 'GET',
               dataType: "json", 
               data: { 
               },
